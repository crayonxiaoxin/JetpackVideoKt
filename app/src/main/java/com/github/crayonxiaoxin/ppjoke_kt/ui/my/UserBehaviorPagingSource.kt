...
class UserBehaviorPagingSource(private val behaviorType: Int?) : PagingSource<Int, Feed>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Feed> {
        ...
        return if (position < 0) {
            ...
            val result = prepare {
                apiService.queryUserBehaviorList(position, behaviorType?:0, pageCount = params.loadSize)
            }
            if (result.isSuccess) {
